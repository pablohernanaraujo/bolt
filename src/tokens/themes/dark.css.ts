// /src/tokens/themes/dark.css.ts
// Dark theme implementation
// Provides dark mode colors and shadows for the design system
// RELEVANT FILES: ../contracts.css.ts, light.css.ts, index.ts
...
export const darkTheme = createTheme(
  ...
  },
  {
    colors: {
      ...
      brand: {
        primary: '#FF6B4F', // Lighter red-orange for better contrast in dark mode
        primaryHover: '#FF4628', // Original red-orange on hover
        primaryActive: '#E63E22', // Darker on active
        secondary: '#9775fa',
      ...
      border: {
        primary: '#373a40',
        secondary: '#2c2e33',
        focus: '#FF6B4F', // Updated to match new primary color
      },
      toast: {
        background: '#25262b',
        border: '#373a40',
    ...
    shadows: {
      ...
      focus: '0 0 0 3px rgb(255 107 79 / 0.25)', // Red Orange with 25% opacity for dark mode
      toast:
