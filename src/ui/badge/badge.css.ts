// /src/ui/badge/badge.css.ts
// Styles for Badge component using vanilla-extract
// Defines variants, color schemes, sizes, and interaction states
// RELEVANT FILES: badge.tsx, ../../tokens/contracts.css, ../../tokens/tokens.css
...
/**
 * Base badge styles
 * Common styles shared by all badge variants
 */
...
/**
 * Solid variant styles for each color scheme
...
/**
 * Subtle variant styles for each color scheme
...
/**
 * Outline variant styles for each color scheme
...
/**
 * Map to group all variants by type
 */
