...
export const ThemeToggle = ({ initialTheme = 'light', showLabel = true, size = 'small', variant = 'secondary', className, ...props }) => {
    ...
    return (_jsxs(Button, { variant: variant, size: size, onClick: toggleTheme, className: themeToggleClassName, "aria-label": `Switch to ${currentTheme === 'light' ? 'dark' : 'light'} theme`, suppressHydrationWarning: true, ...props, children: [_jsx(Icon, { icon: Settings, size: "sm" }), isClient && buttonText] }));
};
