export const generatePaginationItems = (config) => {
...
export const generatePageItems = (currentPage, totalPages, maxVisiblePages) => {
...
export const validatePaginationProps = (currentPage, totalPages) => {
...
export const buildPaginationClassName = (variant, size, className) => {
