...
export const TooltipTrigger = ({ delay = 700, closeDelay = 0, children, ...props }) => (_jsx(AriaTooltipTrigger, { delay: delay, closeDelay: closeDelay, ...props, children: children }));
export const Tooltip = ({ children, placement = 'top', size = 'medium', variant = 'default', offset: customOffset, showArrow = false, maxWidth = 300, className, ...props }) => {
    ...
    return (_jsxs(AriaTooltip, { placement: ariaPlacement, offset: offset, className: tooltipClassName, style: { maxWidth: `${maxWidth}px` }, ...props, children: [showArrow && (_jsx(OverlayArrow, { children: _jsx("div", { className: `${themeClass} ${buildTooltipArrowClassName(variant)}` }) })), _jsx("div", { children: children })] }));
};
