...
function RTLTestWrapper({ children, direction, locale, }) {
    return (<div dir={direction} lang={locale} data-testid="rtl-test-wrapper" data-direction={direction} data-locale={locale}>
      {children}
    </div>);
}
function A11yTestWrapper({ children, simulateScreenReader = false, simulateKeyboardNavigation = false, }) {
    return (<div data-testid="a11y-test-wrapper" data-simulate-screenreader={simulateScreenReader} data-simulate-keyboard={simulateKeyboardNavigation} role="main">
      {children}
    </div>);
}
export function renderWithA11yAndRTL(ui, options = {}) {
    ...
    const Wrapper = ({ children }) => (<RTLTestWrapper direction={direction} locale={locale}>
      <A11yTestWrapper simulateScreenReader={simulateScreenReader} simulateKeyboardNavigation={simulateKeyboardNavigation}>
        {children}
      </A11yTestWrapper>
    </RTLTestWrapper>);
    return render(ui, {
