...
const TabsRoot = forwardRef(({ size = 'medium', variant = 'default', isFitted = false, align = 'start', orientation = 'horizontal', className, children, ...props }, ref) => (_jsx(AriaTabs, { ref: ref, orientation: orientation, className: `${tabsRoot} ${className || ''}`, "data-size": size, "data-variant": variant, "data-fitted": isFitted, "data-align": align, ...props, children: children })));
TabsRoot.displayName = 'Tabs.Root';
const TabsList = forwardRef(({ className, children, ...props }, ref) => (_jsx(AriaTabList, { ref: ref, className: (renderProps) => {
...
const TabsTrigger = forwardRef(({ isDisabled = false, className, children, ...props }, ref) => (_jsx(AriaTab, { ref: ref, isDisabled: isDisabled, className: (renderProps) => {
        const tabsElement = renderProps.defaultClassName
            ? document.querySelector('[data-size]')
            : null;
...
const TabsContent = forwardRef(({ className, children, ...props }, ref) => (_jsx(AriaTabPanel, { ref: ref, className: (renderProps) => {
        const tabsElement = renderProps.defaultClassName
            ? document.querySelector('[data-size]')
            : null;
        const orientation = getOrientation(tabsElement?.getAttribute('aria-orientation'));
