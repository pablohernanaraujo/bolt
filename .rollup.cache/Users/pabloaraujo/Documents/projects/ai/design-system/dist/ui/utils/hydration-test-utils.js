...
export async function testHydrationPerformance(component, strategies) {
    ...
    for (const strategy of strategies) {
        const wrappedComponent = (_jsx("div", { "data-enhancement-strategy": strategy.name, children: component }));
...
export function createHydrationTestWrapper(options = {}) {
    const HydrationTestWrapper = ({ children, }) => {
        ...
        return (_jsx("div", { "data-test-hydration": "true", "data-test-options": JSON.stringify(options), children: children }));
    };
