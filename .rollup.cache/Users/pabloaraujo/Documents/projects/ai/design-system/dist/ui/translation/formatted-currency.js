...
export async function FormattedCurrency({ value, currency: customCurrency, options = {}, locale: customLocale, as: Component = 'span', className, fallbackChildren, ...props }) {
    try {
        ...
        return (_jsx(Component, { className: className, ...accessibilityProps, ...props, children: formattedCurrency }));
    }
    catch (error) {
        console.warn('Currency formatting failed:', error);
        const fallbackCurrency = customCurrency || 'USD';
        const fallbackText = `${fallbackCurrency} ${value}`;
        return (_jsx(Component, { className: className, "data-formatting-error": "true", "aria-label": `${value} ${fallbackCurrency}`, ...props, children: fallbackChildren || fallbackText }));
    }
}
export function FormattedCurrencySync({ value, currency = 'USD', options = {}, locale = 'en-US', as: Component = 'span', className, fallbackChildren, ...props }) {
    try {
        ...
        return (_jsx(Component, { className: className, "data-formatting-error": "true", "aria-label": `${value} ${currency}`, ...props, children: fallbackChildren || fallbackText }));
    }
}
