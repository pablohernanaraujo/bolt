...
export const ThemeToggle = ({ initialTheme = 'light', showLabel = true, size = 'small', variant = 'secondary', className, ...props }) => {
    ...
    return (<Button variant={variant} size={size} onClick={toggleTheme} className={themeToggleClassName} aria-label={`Switch to ${currentTheme === 'light' ? 'dark' : 'light'} theme`} suppressHydrationWarning {...props}>
