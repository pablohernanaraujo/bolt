...
export const PinInputGroup = ({ children, className, }) => {
    ...
    const combinedClassName = className
        ...
        : groupClassName;
    return (_jsx("div", { className: combinedClassName, role: "group", children: children }));
};
...
export const PinInputSeparator = ({ children = '-', className, }) => {
    const combinedClassName = className
        ...
        : pinInputSeparator;
    return (_jsx("div", { className: combinedClassName, "aria-hidden": "true", children: children }));
};
