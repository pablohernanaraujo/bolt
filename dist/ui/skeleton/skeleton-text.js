...
import { mergeSkeletonProps, generateTextLines, getSkeletonAriaAttributes, buildSkeletonClassName } from './helpers.js';
import { skeletonText, skeletonTextLine } from './skeleton.css.js';
...
const SkeletonText = forwardRef((props, ref) => {
    ...
    return (jsx("div", { ref: ref, className: `${skeletonText} ${className || ''}`, style: containerStyle, ...ariaAttributes, ...htmlProps, children: textLines.map((line, index) => {
            ...
            return (jsx("div", { className: lineClassName, style: lineStyle, "aria-hidden": "true" }, line.key));
        }) }));
});
