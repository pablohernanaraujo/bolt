...
const ThemeToggleProgressive = ({ initialTheme, showLabel = true, size = 'small', variant = 'secondary', className, ...props }) => {
    ...
    return (jsxs("form", { ref: formRef, method: "POST", action: "/api/theme", style: { display: 'inline' }, children: [jsx("input", { type: "hidden", name: "theme", value: nextTheme }), jsxs(ButtonServer, { type: "submit", variant: variant, size: size, className: themeToggleClassName, "aria-label": `Switch to ${nextTheme} theme`, "data-enhanced": isEnhanced, ...props, children: [jsx(Icon, { icon: Settings, size: "sm" }), buttonText] })] }));
};

export { ThemeToggleProgressive };
//# sourceMappingURL=theme-toggle-progressive.js.map
