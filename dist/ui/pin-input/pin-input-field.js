...
import { getDisplayValue, INPUT_MODES, handlePasteContent, handleKeyNavigation, handleCharInput } from './helpers.js';
import { PinInputContext } from './pin-input-context.js';
import { pinInputFieldRecipe } from './pin-input.css.js';

const PinInputField = forwardRef(({ index, className }, ref) => {
