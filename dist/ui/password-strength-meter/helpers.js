...
const buildStrengthMeterClassName = (strength, size, className) => {
    const classes = [
...
export { DEFAULT_STRENGTH_LABELS, buildStrengthMeterClassName, calculatePasswordStrength, getStrengthColors };
