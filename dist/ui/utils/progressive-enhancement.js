...
const shouldEnhanceComponent = (options = {}) => {
...
const createVisibilityObserver = (callback, options = {}) => {
...
const enhanceForm = (formElement, onSubmit) => {
...
const enhanceButton = (buttonElement, onClick) => {
...
const isKeyboardNavigationPreferred = () => {
    if (typeof window === 'undefined')
        return false;
    try {
...
const enhanceFocusManagement = (containerElement, options = {}) => {
...
const enhanceScreenReaderAnnouncement = (message, priority = 'polite') => {
...
const useProgressiveEnhancement = (dependencies = []) => ({
...
export { ENHANCEMENT_CONFIGS, createVisibilityObserver, enhanceButton, enhanceFocusManagement, enhanceForm, enhanceScreenReaderAnnouncement, isJavaScriptAvailable, isKeyboardNavigationPreferred, isScreenReaderDetected, shouldEnhanceComponent, useProgressiveEnhancement };
//# sourceMappingURL=progressive-enhancement.js.map
