/*! For license information please see 720.e6dde216.iframe.bundle.js.LICENSE.txt */
'use strict';
(self.webpackChunkdesign_system = self.webpackChunkdesign_system || []).push([
  [720],
  {
    './node_modules/.pnpm/@storybook+react-dom-shim@8.6.14_react-dom@19.1.0_react@19.1.0__react@19.1.0_storybook@8.6.14_prettier@3.6.2_/node_modules/@storybook/react-dom-shim/dist/react-18.mjs':
      (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        ...
        var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
          ...
          react_dom_client__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
            './node_modules/.pnpm/next@15.4.6_@babel+core@7.28.3_react-dom@19.1.0_react@19.1.0__react@19.1.0/node_modules/next/dist/compiled/react-dom/client.js',
          ),
          nodes = new Map();
    ...
    './node_modules/.pnpm/next@15.4.6_@babel+core@7.28.3_react-dom@19.1.0_react@19.1.0__react@19.1.0/node_modules/next/dist/compiled/react-dom/cjs/react-dom-client.production.js':
      (__unused_webpack_module, exports, __webpack_require__) => {
        var process = __webpack_require__(
          ...
          Scheduler = __webpack_require__(
            './node_modules/.pnpm/next@15.4.6_@babel+core@7.28.3_react-dom@19.1.0_react@19.1.0__react@19.1.0/node_modules/next/dist/compiled/scheduler/index.js',
          ),
          React = __webpack_require__(
            './node_modules/.pnpm/next@15.4.6_@babel+core@7.28.3_react-dom@19.1.0_react@19.1.0__react@19.1.0/node_modules/next/dist/compiled/react/index.js',
          ),
          ReactDOM = __webpack_require__(
            './node_modules/.pnpm/next@15.4.6_@babel+core@7.28.3_react-dom@19.1.0_react@19.1.0__react@19.1.0/node_modules/next/dist/compiled/react-dom/index.js',
          );
        ...
        function updateSuspenseComponent(current, workInProgress, renderLanes) {
            ...
            return (
              ...
              showFallback
                ? (reuseSuspenseHandlerOnStack(),
                  ...
                  ((nextPrimaryChildren = workInProgress.child).memoizedState =
                    mountSuspenseOffscreenState(renderLanes)),
                  (nextPrimaryChildren.childLanes =
          ...
          return showFallback
            ? (reuseSuspenseHandlerOnStack(),
              ...
              null === (showFallback = current.child.memoizedState)
                ? (showFallback = mountSuspenseOffscreenState(renderLanes))
                : (null !== (prevState = showFallback.cachePool)
                  ...
                  (function attemptEarlyBailoutIfNoScheduledUpdate(
                    ...
                    switch (workInProgress.tag) {
                      ...
                      case 13:
                        ...
                        if (null !== state$100)
                          return null !== state$100.dehydrated
                            ? (pushPrimaryTreeSuspenseHandler(workInProgress),
                              (workInProgress.flags |= 128),
                              null)
                            : 0 !==
          ...
          switch (((workInProgress.lanes = 0), workInProgress.tag)) {
            ...
            case 31:
              if (
                ...
                (nextState = !!(128 & workInProgress.flags)),
                ...
                if (isHydrating) {
                  if ('hidden' === init.mode)
                    ...
                    throw throwOnHydrationMismatch(workInProgress);
                  ((workInProgress.lanes = 536870912), (workInProgress = null));
                } else
                  workInProgress = mountActivityChildren(workInProgress, init);
              else if (null !== (lazyComponent = current.memoizedState))
                if (
                  ...
                  if (
                    null !== (init = workInProgressRoot) &&
                    0 !==
                      (prevState = getBumpedLaneForHydration(
                        init,
                        renderLanes,
                      )) &&
                    prevState !== lazyComponent.retryLane
                  )
                    throw (
          ...
          if (didBailout)
            for (var child$105 = completedWork.child; null !== child$105; )
              ((newChildLanes |= child$105.lanes | child$105.childLanes),
                (subtreeFlags |= 65011712 & child$105.subtreeFlags),
                (subtreeFlags |= 65011712 & child$105.flags),
          ...
          try {
            ...
            (!(function updateProperties(
              ...
              switch (tag) {
                ...
                case 'textarea':
                  for (defaultValue in ((propKey = propKey$199 = null),
                  lastProps))
                    if (
                  ...
                  return void updateTextarea(domElement, propKey$199, propKey);
                case 'option':
                  for (var propKey$215 in lastProps)
                    if (
                      ...
                      if ('selected' === propKey$215) domElement.selected = !1;
                      else
                        setProp(
                          domElement,
                          tag,
        ...
        function flushSyncWorkAcrossRoots_impl(
          ...
          if (!isFlushingWork && mightHavePendingSyncWork) {
            ...
            do {
              for (
                var didPerformSomeWork = !1, root$168 = firstScheduledRoot;
                null !== root$168;
              ...
              if (isCustomElement(tag)) {
                for (propValue$182 in props)
                  props.hasOwnProperty(propValue$182) &&
                    void 0 !== (hasSrc = props[propValue$182]) &&
                    setPropOnCustomElement(
                      domElement,
                      tag,
                      propValue$182,
    ...
    './node_modules/.pnpm/next@15.4.6_@babel+core@7.28.3_react-dom@19.1.0_react@19.1.0__react@19.1.0/node_modules/next/dist/compiled/scheduler/cjs/scheduler.production.js':
      (__unused_webpack_module, exports, __webpack_require__) => {
        var console = __webpack_require__(
          './node_modules/.pnpm/console-browserify@1.2.0/node_modules/console-browserify/index.js',
        );
