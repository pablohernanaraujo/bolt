...
(self.webpackChunkdesign_system = self.webpackChunkdesign_system || []).push([
  [810],
  {
    './node_modules/.pnpm/@storybook+addon-a11y@8.6.14_storybook@8.6.14_prettier@3.6.2_/node_modules/@storybook/addon-a11y/dist/matchers-7Z3WT2CE.mjs':
      (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        ...
        var ansi_styles_default = (function assembleStyles() {
            ...
            return (
              ...
              Object.defineProperties(styles, {
                ...
                hexToRgb: {
                  value(hex) {
                    let matches = /[a-f\d]{6}|[a-f\d]{3}/i.exec(
                      hex.toString(16),
                    );
          ...
          level = (() => {
            ...
            return /\b(Chrome|Chromium)\//.test(globalThis.navigator.userAgent)
              ? 1
              : 0;
          })(),
        ...
        function stringReplaceAll(string, substring, replacer) {
          ...
          do {
            ((returnValue +=
              string.slice(endIndex, index) + substring + replacer),
        ...
        var getModelAnsi = (model, level2, type, ...arguments_) =>
          'rgb' === model
            ? 'ansi16m' === level2
              ...
              : 'ansi256' === level2
                ? ansi_styles_default[type].ansi256(
                    ansi_styles_default.rgbToAnsi256(...arguments_),
                  )
                : ansi_styles_default[type].ansi(
        ...
        var proto = Object.defineProperties(() => {}, {
          ...
          applyStyle = (self, string) => {
            ...
            return (
              -1 !== lfIndex &&
                (string = (function stringEncaseCRLFWithFirstIndex(
                  string,
                  prefix,
                  postfix,
                  index,
        ...
        var mod,
                ...
                get: function assembleStyles2() {
                  ...
                  return (
                    ...
                    Object.defineProperties(styles3, {
                      ...
                      hexToAnsi256: {
                        value: (hex) =>
                          styles3.rgbToAnsi256(...styles3.hexToRgb(hex)),
                        enumerable: !1,
                      },
                    }),
                    styles3
                ...
                (exports.printListItems = function printListItems(
                  ...
                  if (list.length) {
                    ...
                    for (let i = 0; i < list.length; i++) {
                      if (
                        ((result += indentationNext), i === config.maxWidth)
                      ) {
                        result += '…';
                        break;
                      }
          ...
          require_ConvertAnsi = __commonJS({
            'node_modules/pretty-format/build/plugins/ConvertAnsi.js'(exports) {
              ...
              var test = (val) =>
                'string' == typeof val &&
                !!val.match((0, _ansiRegex.default)());
              exports.test = test;
              var serialize = (
                val,
                config,
            ...
            'node_modules/react-is/cjs/react-is.development.js'(exports) {
              !(function () {
                var REACT_MODULE_REFERENCE,
                  ...
                  REACT_SERVER_CONTEXT_TYPE = Symbol.for(
                ...
                ((exports.ContextConsumer = ContextConsumer),
                  ...
                  (exports.isConcurrentMode = function isConcurrentMode(
                    object,
                  ) {
                    return (
          ...
          require_ReactElement = __commonJS({
            'node_modules/pretty-format/build/plugins/ReactElement.js'(
              ...
              (Object.defineProperty(exports, '__esModule', { value: !0 }),
                (exports.test = exports.serialize = exports.default = void 0));
              var ReactIs = (function _interopRequireWildcard(
                  obj,
                  nodeInterop,
                ) {
            ...
            'node_modules/pretty-format/build/index.js'(exports) {
              ...
              var toString = Object.prototype.toString,
                ...
                getConstructorName = (val) =>
                  ('function' == typeof val.constructor &&
                    val.constructor.name) ||
                  'Object',
                  ...
                  : (function isToStringedArrayType(toStringed) {
                    ...
                    : '[object Map]' === toStringed
                      ...
                      : '[object Set]' === toStringed
                        ...
                        : hitMaxDepth ||
                            ((val) => typeof window < 'u' && val === window)(
                              val,
                            )
                          ? `[${getConstructorName(val)}]`
              ...
              function findPlugin(plugins2, val) {
                for (let p = 0; p < plugins2.length; p++)
                  try {
                    ...
                    throw new PrettyFormatPluginError(
                      error.message,
                      error.stack,
                    );
                  }
              ...
              var getColorsHighlight = (options) =>
                ...
                getPrintFunctionName = (options) => {
                  ...
                  return null !==
                    (_options$printFunctio = options?.printFunctionName) &&
                ...
                getEscapeRegex = (options) => {
                  ...
                  return null !==
                    (_options$escapeRegex = options?.escapeRegex) &&
                ...
                getEscapeString = (options) => {
                  ...
                  return null !==
                    (_options$escapeString = options?.escapeString) &&
                  ...
                  return {
                    ...
                    indent:
                      null != options && options.min
                        ? ''
                        : ((indent =
                            null !== (_options$indent = options?.indent) &&
                            void 0 !== _options$indent
                              ? _options$indent
                              : DEFAULT_OPTIONS.indent),
                          new Array(indent + 1).join(' ')),
                    maxDepth:
                      null !== (_options$maxDepth = options?.maxDepth) &&
                      void 0 !== _options$maxDepth
                        ? _options$maxDepth
                        : DEFAULT_OPTIONS.maxDepth,
                    maxWidth:
                      null !== (_options$maxWidth = options?.maxWidth) &&
                      void 0 !== _options$maxWidth
                        ? _options$maxWidth
                        : DEFAULT_OPTIONS.maxWidth,
                    min:
                      null !== (_options$min = options?.min) &&
                      void 0 !== _options$min
                        ? _options$min
                        : DEFAULT_OPTIONS.min,
                    plugins:
                      null !== (_options$plugins = options?.plugins) &&
                      void 0 !== _options$plugins
                        ? _options$plugins
                        : DEFAULT_OPTIONS.plugins,
                    printBasicPrototype:
                      null ===
                        (_options$printBasicPr =
                          options?.printBasicPrototype) ||
        ...
        function printReceived(object) {
          return RECEIVED_COLOR(
            (function replaceTrailingSpaces(text) {
              return text.replace(/\s+$/gm, (spaces) =>
        ...
        function toHaveNoViolations(results) {
          ...
          let violations = (function filterViolations(
            violations,
            impactLevels,
          ) {
                  ...
                  (function matcherHint(
                    ...
                    return (
                      !isDirectExpectCall &&
                        '' !== received &&
                        ((hint +=
                          DIM_COLOR(`${dimString}(`) + receivedColor(received)),
                        (dimString = ')')),
                      '' !== promise &&
                      ...
                      '' === expected
                        ...
                        : ((hint +=
                          ...
                          secondArgument &&
                            (hint +=
                              DIM_COLOR(', ') +
                              secondArgumentColor(secondArgument)),
                          (dimString = ')')),
